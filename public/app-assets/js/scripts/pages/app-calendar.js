...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function eventClick(info) {
    ...
    var __del = "<input name='id' id='event_id' value='"+eventToUpdate.id+"' hidden>";
    $("#del").html(__del + "<input name='type' type='hidden' value='delete'>");
  ...
  function updateEvent(eventData) {
    ...
    var extendedPropsToUpdate = ['calendar', 'guests', 'customer', 'description'];
