...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    //for test
    Route::group(['prefix' => 'hubspot', 'as' => 'hubspot.'], function () {
        Route::any('index', [HubspotController::class, 'index'])->name('index');
    });
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::any('colors',           'SystemController@colors')->name('colors');
        ...
        Route::group(['prefix' => 'promotion', 'as' => 'promotion.'], function () {
            ...
            Route::post('store-promotion',  [PromotionController::class, 'store'])->name('create.save');
            Route::get('edit/{id}',         [PromotionController::class, 'edit'])->name('edit');
            Route::post('update/{id}',      [PromotionController::class, 'update'])->name('update.save');
            Route::get('delete/{id}',       [PromotionController::class, 'destroy'])->name('delete');
        });

        Route::group(['prefix' => 'units', 'as' => 'units.', 'middleware' => ['module:attribute']], function () {
            Route::get('view', 'UnitsController@index')->name('view');
            Route::get('fetch', 'UnitsController@fetch')->name('fetch');
            Route::post('store', 'UnitsController@store')->name('store');
            Route::post('edit', 'UnitsController@edit')->name('edit');
            Route::post('update', 'UnitsController@update')->name('update');
            Route::post('delete', 'UnitsController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'deal', 'as' => 'deal.', 'middleware' => ['module:deal']], function () {
            ...
            Route::get('_delete/{id}', 'DealController@__delete')->name('__delete');
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.', 'middleware' => ['module:category']], function () {
            ...
            Route::any('delete', 'CategoryController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'sub-category', 'as' => 'sub-category.', 'middleware' => ['module:category']], function () {
            ...
            Route::get('fetch/{id}', 'SubCategoryController@fetch')->name('fetch');
            // Route::get('fetch/{id}', 'SubCategoryController@fetch', function($id) {
        ...
        Route::group(['prefix' => 'sub-sub-category', 'as' => 'sub-sub-category.', 'middleware' => ['module:category']], function () {
            ...
            Route::get('fetch/{id}', 'SubSubCategoryController@fetch')->name('fetch');
        ...
        Route::group(['prefix' => 'support-ticket', 'as' => 'support-ticket.'], function () {
            ...
            Route::get('delete-ticket/{id}', 'SupportTicketController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.'], function () {
            ...
            Route::get('delete/{user_id}', 'CustomerController@delete')->name('delete');
        });
        ///Report
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.'], function () {
            ...
            Route::get('delete/{id}', 'SellerController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'mail'], function () {            
            Route::match(['get', 'post'], 'system-wide', 'MailController@send_mail')->name('send.mail');
            Route::match(['get', 'post'], 'mail-seller', 'MailController@Sellersend_mail')->name('seller.send.mail');
            Route::match(['get', 'post'], 'mail-user', 'MailController@Usersend_mail')->name('user.send.mail');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::match(['get', 'post'], 'mail-update', 'BusinessSettingsController@mail_settings')->name('mail-settings');
            ...
            Route::any('social-media-delete', 'BusinessSettingsController@social_media_delete')->name('social-media-delete');
            ...
            Route::match(['get', 'post', 'put'], 'privacy-policy', 'BusinessSettingsController@privacy_policy')->name('privacy-policy');
            Route::match(['get', 'post', 'put'], 'return-policy', 'BusinessSettingsController@return_policy')->name('return-policy');

            Route::match(['get', 'post', 'put'], 'units', 'UnitsController@units')->name('units');
            ...
            Route::group(['prefix' => 'social-login', 'as' => 'social.'], function () {
                Route::get('facebook', 'ShippingMethodController@index')->name('facebook');
                Route::post('facebook', 'ShippingMethodController@store')->name('facebook.update');
                Route::get('google', 'ShippingMethodController@edit')->name('google');
                Route::post('google', 'ShippingMethodController@update')->name('google.update');
                Route::get('twitter', 'ShippingMethodController@delete')->name('twitter');
                Route::post('twitter', 'ShippingMethodController@status_update')->name('twitter.update');
            });
        ...
        Route::group(['prefix' => 'plans', 'as' => 'subscription.'], function () {
            ...
            Route::any('add', [SubscriptionController::class, 'add_subscription'])->name('add');
            Route::any('delete/{id}', [SubscriptionController::class, 'destroy'])->name('delete');
            Route::get('edit', [SubscriptionController::class, 'edit'])->name('edit');
            Route::post('edit/{id}/save', [SubscriptionController::class, 'update'])->name('update');
        });
        ...
        Route::group(['prefix' => 'blog'], function () {
            ...
            Route::post('add-blog-post', [BlogController::class, 'store'])->name('blog.store');
        });

        // Menu Routes
        Route::group(['prefix' => 'menu', 'as' => 'menu.'], function () {
            Route::any('list',          [MenuController::class, 'index'])->name('list');
            Route::any('add',           [MenuController::class, 'navbar'])->name('add');
            Route::any('delete/{id}',   [MenuController::class, 'destroy'])->name('delete');
            Route::any('edit/{id}',     [MenuController::class, 'edit'])->name('edit');
        });
    });
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    Route::get('attribute', [AttributeController::class, 'index'])->name('attr.index');
});
