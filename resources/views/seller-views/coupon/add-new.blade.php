    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('seller.coupon.add-new')}}" method="post">
                        @csrf
                        ...
                        <table id="datatable"
                            ...
                            @foreach($cou as $k=>$c)
                                <tr>
                                    ...
                                    <td>
                                      <label class="switch">
                                      <input type="checkbox" class="status" id="{{$c->id}}" @if ($c->published == 1) checked @endif>
                                            <span class="slider round"></span>
                                      </label>
                                    </td>
                                    <td>
                                        <a href="{{route('seller.coupon.update', $c->id)}}">
                                           <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="{{route('seller.coupon.delete', $c->id)}}">
