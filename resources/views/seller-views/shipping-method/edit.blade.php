                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 sec">
                                    ...
                                    <input type="number" id="cost" step="any" name="cost" value="{{ $method->cost }}" class="form-control" placeholder="Ex : 10 $">
                                </div>

                                <div class="col-md-6 sec" hidden>
                                    <label for="cost">Per Qty Additional price</label>
                                    <input type="number" step="any" id="cost" name="_cost" class="form-control" placeholder="Ex : 10 $">
                                </div>
