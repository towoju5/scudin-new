                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">{{__('Full')}} {{__('name')}}  <i
                                ...
                                <div class="col-sm-9 row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="name">{{__('Last')}} {{__('Name')}}  <span class="text-danger">*</span></label>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm','Want to update admin password ?')":"call_demo()"}}" class="btn btn-primary">{{__('Save')}} {{__('changes')}}</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
