...
<section class="main-container col2-right-layout">
  <div class="main container">
    <div class="row m-3">
      <section class="col-sm-9 bg-white">
            ...
            <div style="margin: 0 auto; padding: 15px;">
              ...
              <form action="{{route('track-order.result')}}" type="submit" method="post" style="padding: 35px;">
                ...
                <div class="form-group mb-3">
                  ...
                  <input class="form-control prepended-form-control" type="text" name="phone_number" id="phone_number" placeholder="Enter Your Phone Number" required>
                </div>
                <div class="text-center">
                  <button class="btn btn-scudin btn-lg" type="submit" name="trackOrder"> <i class="lni lni-search"></i> Track Order</button>
                </div>
              </form>
            </div>
          </div>
