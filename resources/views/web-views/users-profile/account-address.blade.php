...
<section class="main-container col2-right-layout mt-3">
            ...
            <div class="row">
              <div class="row" style="margin-bottom: 4rem;">
                <div class="col-sm-12 bg-white">
                  <h1 class="h3 headerTitle" style="float: left;">{{ __('DELIVERY ADDRESS')}}</h1>
                </div>
              </div>
              <section class="row">
                @foreach($shippingAddresses as $shippingAddress)
                <div class="col-md-12 bg-white p-3" style="text-transform: capitalize;">
                  {{-- <div class="card cardColor"> --}}
                  <div class="card-header d-flex">
                    <div>
                      <i class="fa fa-thumb-tack fa-2x iconHad" aria-hidden="true"></i>
                      <span class="namHad h4 mb-2"> {{$shippingAddress['address_type']}} {{ __('address')}} </span>
                    </div>
                    <a class="btn btn-primary btn-xs" data-backdrop="false" id="edit" data-toggle="modal" onclick="$('#editAddress_{{$shippingAddress->id}}').modal('show')">
                        ...
                        <div class="modal-body">
                          <form id="updateForm">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="closeB btn btn-secondary" onclick="$('#editAddress_{{$shippingAddress->id}}').modal('hide')">{{ __('close')}}</button>
                  ...
                  <div class="card-body mt-3">
                    <div class="h3 pb-3"><span>{{$shippingAddress['contact_person_name']}}</span>
                    </div>
                    <div><span class="h6 pb-2"> <strong>{{ __('Phone')}} :</strong> {{$shippingAddress['phone']}}</span>
                    </div>
                    <div><span class="h6 pb-2"> <strong>{{ __('City')}} :</strong> {{$shippingAddress['city']}}</span>
                    </div>
                    <div><span class="h6 pb-2"> <strong> {{ __('zip_code')}} :</strong> {{$shippingAddress['zip']}}</span>
                    </div>
                    <div><span class="h6 pb-2"> <strong>{{ __('address')}} :</strong> {{$shippingAddress['address']}}</span>
                    </div>
                    <div><span class="h6 pb-2"> <strong>{{ __('State')}} :</strong> {{$shippingAddress['state']}}</span>
                    </div>
                    <div><span class="h6 pb-2"> <strong>{{ __('Country')}} :</strong> {{$shippingAddress['country']}}</span>
                    </div>
                  </div>
                  {{-- </div> --}}
                </div>
