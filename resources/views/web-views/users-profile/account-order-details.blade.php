          ...
          <div class="dashboard">
            <div class="recent-orders">
              ...
              <div class="table-responsive">
                ...
                @endif
                <table class="table data-table table-striped" id="my-orders-table">
                  <thead>
                    <tr class="first last">
                      <th>{{ __('Order#') }} </th>
                      <th>{{ __('order_date') }}</th>
                ...
                <div class="col-md-12">
                  <div class="row d-flex mt-4 gap-2">
                    <a href="{{route('generate-invoice',[$order->id])}}" class="btn btn-primary for-glaxy-mobile" style="min-width:40%;">
                      {{ __('generate_invoice')}}
                    </a>
                    <a id="track_order" class="btn btn-secondary" type="button" style="min-width:40%;">
                      {{ __('Track')}} {{ __('Order')}}
                    </a>
                  </div>
                </div>
