      ...
      <div class="col-md-8">
         <div class="card">
            ...
            <div class="confirmation_container">
               <div class="row">
                  <div class="col-md-6 yourOrder">
                     <h5 style="font-size: 20px; font-weight: 900">Your order
                        Confirmed!</h5>
                  </div>
                  <div class="col-md-6 ">
                     <p class="float-right orderId ">Order No: <strong>RM984893</strong>
                     </p>
                  </div>
               </div>

               <span class="font-weight-bold d-block mt-4" style="font-size: 17px;">Hello, Refat</span> <span>You order
                  has been confirmed and will be shipped in next two days!</span>
                     ...
                     <tbody>
                        <tr>
                           <div class="row">
                              <div class="col-md-3">
                                 ...
                                 <td width="60%" class="paddingtd"><span class="font-name">Bee Willow Home Hand-quilted
                                       Velvet Quiit Set</span>
                                    <div class="product-qty"><span class="d-block">Size : L </span></div>
                                 </td>
                              </div>
                              <div class="col-md-6">
                                 <td width="20%" class="paddingtd">
                                    <div class="text-right"><span class="font-weight-bold amount">$345.50</span></div>
                                 </td>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-md-3">
                                 <td width="30%"><img src="{{asset("storage/app/public/product/th02.jpg")}}"
                                       width="100"></td>
                                 <td width="60%"><span class="font-name">Bee Willow Home Hand-quilted Velvet Quiit
                                       Set</span>
                              ...
                              <div class="col-md-6">
                                 <td width="20%">
                                    <div class="text-right"><span class="font-weight-bold amount">$78.50</span></div>
                                 </td>
                              </div>
                           </div>
                        ...
                        <tr>
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <td width="20%">
                                    <div class="text-right"><span class="font-weight-bold amount ">$797.50</span></div>
                                 </td>
                              </div>
                           </div>
               ...
               <div class="contact">
                  <p class="float-right mt-3 contact "><span style="font-size: 16px; font-weight: 400;">Nedd Help
                        ?</span>
                     <a href="" style="color:  #1B7FED;">Contact To Help Center</a>
                  </p>
               </div>
            </div>
