          ...
          <div class="m-3 bg-white p-3">
            ...
            <div class="btn-primary">
              <div class=" d-lg-flex justify-content-between py-2 py-lg-3">
                ...
                <div class="order-lg-1 pr-lg-4 text-center text-lg-left" style="padding: 5px;">
                  <h4 class="mb-0">Order ID : <span class="h4 font-weight-normal">{{$orderDetails['id']}}</span></h4>
                </div>
              </div>
            </div>
            <!-- Page Content-->
            <div class="mb-md-3">
              ...
              <div class="row" style="background: #e2f0ff; margin: 0; width: 100%; padding: 5px;">
                <div class="col-sm-4">
                  <div class="pt-2 pb-2 text-left rounded-lg">
                ...
                <div class="col-sm-4">
                  <div class="pt-2 pb-2 text-end rounded-lg">
                ...
                <div class="row" style="padding-bottom: 15px;">
                  <div class="col-md-5 text-left">
                    <div style="float: left;">
                      <a class="text-dark pr-2" href="{{route('product',$productDetails->slug)}}" style="width: 10rem;">
                        <img src="{{ asset($productDetails->thumbnail) }}" width="50px" height="50px">
                      </a>
                    </div>
                    <div class="media-body pt-2">
                      <h6 class="product-title mb-2"><a href="{{route('product',$productDetails->slug)}}">{{$productDetails['name']}}</a>
                      </h6>
...
@stop
@push('js')
<script>$('.bg-white').matchHeight()</script>
@endpush