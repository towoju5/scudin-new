...
<div class="container-fluid">
    ...
    @php
    $array=[];
    for ($i=1;$i<=12;$i++){ $from=date('Y-'.$i.'-01'); $to=date('Y-'.$i.'-30'); $array[$i]=\App\Model\OrderDetail::where(['seller_id'=> auth('staff')->user()->seller_code])->whereBetween('created_at', [$from, $to])->count();
        }
        @endphp
        ...
        <div class="row gx-2 gx-lg-3">
                ...
                <a class="card card-hover-shadow h-100" href="{{route('seller.orders.list',['pending'])}}">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                @php
                                $pendingOrder = \App\Model\OrderDetail::where(['seller_id' => auth('staff')->user()->seller_code])
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                ...
                @php
                $array=[];
                for ($i=1;$i<=12;$i++){ $from=date('Y-'.$i.'-01'); $to=date('Y-'.$i.'-30'); $array[$i]=\App\Model\OrderDetail::where(['seller_id'=> auth('staff')->user()->seller_code])->where(['delivery_status'=>'delivered'])->whereBetween('created_at', [$from, $to])->count();
                    }
                    @endphp
                    <a class="card card-hover-shadow h-100" href="{{route('seller.orders.list',['delivered'])}}">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center gx-2 mb-1">
                                <div class="col-12">
                                    @php
                                    $deliveredOrder= \App\Model\OrderDetail::where(['seller_id' => auth('staff')->user()->seller_code])
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                ...
                @php
                $array=[];
                for ($i=1;$i<=12;$i++){ $from=date('Y-'.$i.'-01'); $to=date('Y-'.$i.'-30'); $array[$i]=\App\Model\OrderDetail::where(['seller_id'=> auth('staff')->user()->seller_code])->where(['delivery_status'=>'returned'])->whereBetween('created_at', [$from, $to])->count();
                    }
                    @endphp
                    <a class="card card-hover-shadow h-100" href="{{route('seller.orders.list',['returned'])}}">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center gx-2 mb-1">
                                <div class="col-12">
                                    @php
                                    $returnedOrder= \App\Model\OrderDetail::where(['seller_id' => auth('staff')->id()])
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                ...
                @php
                $array=[];
                for ($i=1;$i<=12;$i++){ $from=date('Y-'.$i.'-01'); $to=date('Y-'.$i.'-30'); $array[$i]=\App\Model\OrderDetail::where(['seller_id'=> auth('staff')->user()->seller_code])->where(['delivery_status'=>'failed'])->whereBetween('created_at', [$from, $to])->count();
                    }
                    @endphp
                    <a class="card card-hover-shadow h-100" href="{{route('seller.orders.list',['failed'])}}">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center gx-2 mb-1">
                                <div class="col-12">
                                    @php
                                    $failedOrder= \App\Model\OrderDetail::where(['seller_id' => auth('staff')->user()->seller_code])
                        ...
                        <div class="card-body text-light">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    @php
                                    $wallet = \App\Model\SellerWallet::where('seller_id',auth('staff')->user()->seller_code)->first();
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-lg-12 mb-3 mb-lg-12">
                ...
                <div class="card h-100">
                    ...
                    @php
                    $array=[];
                    for ($i=1;$i<=12;$i++){ $from=date('Y-'.$i.'-01'); $to=date('Y-'.$i.'-30'); $array[$i]=\App\Model\OrderDetail::where('seller_id',auth('staff')->user()->seller_code)->where(['delivery_status'=>'delivered'])->whereBetween('created_at', [$from, $to])->sum('price');
                        }
                        @endphp
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-sm mb-2 mb-sm-0">
                                    <div class="d-flex align-items-center">
                                        @php($this_month=\App\Model\OrderDetail::where('seller_id',auth('staff')->user()->seller_code)->where(['delivery_status'=>'delivered'])->whereBetween('updated_at', [date('Y-m-01'), date('Y-m-30')])->sum('price'))
                                        @php($amount=0)
