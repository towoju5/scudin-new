            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <span>Discount :
                            <span> {{ $product->discount_type=='flat'?\App\CPU\BackEndHelper::usd_to_currency($product->discount).''.\currency_symbol(): $product->discount.''.'%'}}</span>
                        </span><br>
                        <span>Current Stock :
                                   ...
                                   href="{{route('admin.customer.view',[$review['customer_id']])}}">
                                    <div class="avatar avatar-circle">
                                        <img
                                            class="avatar-img"
                                            onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                            src="{{asset('storage/profile/'.$review->customer->image)}}" width="50px" height="50px"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3">
