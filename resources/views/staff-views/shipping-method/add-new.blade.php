                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pri">
                                    ...
                                    <select name="title" class="form-control" id="shipping_method">
                                        ...
                                        <option value="UPS Standard">UPS Standard</option>
                                        <option value="UPS Overnight Priority">UPS Overnight Priority</option>
                                        
                                        <option value="FedEx Standard">FedEx Standard</option>
                                        <option value="FedEx Overnight Priority">FedEx Overnight Priority</option>
                                        <option value="FedEx Express International Export">FedEx Express International Export</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 sec">
                                    ...
                                    <input type="number" id="cost" name="cost" class="form-control" placeholder="Ex : 10 $">
                                </div>
                                ...
                                <td style="display: flex; width:100%;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{route('seller.business-settings.shipping-method.edit',[$method['id']])}}">{{__('Edit')}}</a>
                                            <a class="dropdown-item" href="javascript:" onclick="form_alert('product-{{$method->id}}','Want to delete this item ?')">{{__('Delete')}}</a>
                                            <form action="{{route('seller.business-settings.shipping-method.delete',[$method['id']])}}" method="post" id="product-{{$method['id']}}">
                                                @csrf @method('delete')
                                            </form>
                                        </div>
                                    </div>
