...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class=" mb-0 text-black-50">{{ __('Attribute')}}</h4>
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-md-4">
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label for="name">{{ __('Attribute')}} {{ __('Name')}} </label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Enter Attribute Name">
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        datatable = $('#dataTable').DataTable({
            ...
            responsive: true,
            ordering: false,
            ajax: "{{ route('admin.attribute.fetch') }}",
            columns: [{
                    data: 'id'
                },
                {
            ...
            "columnDefs": [{
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            '<a href="javascript:;" class="item-edit" onclick=_edit(' + full.id + ')>' +
