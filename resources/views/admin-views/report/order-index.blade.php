                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title">{{__('Order')}} {{__('Report')}}  {{__('Overview')}}</h1>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="row align-items-center g-0">
                                        <div class="col-auto pr-2">{{__('Date')}}</div>
            ...
            <span class="hs-nav-scroller-arrow-prev" style="display: none;">
              ...
              <a class="hs-nav-scroller-arrow-link" href="javascript:;">
                ...
                <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="javascript:">{{__('Overview')}}</a>
                    </li>
                </ul>
            </div>
            <!-- End Nav -->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1">{{__('Processing')}}</h4>
                ...
                <div class="hs-unfold">
                    <a class="js-hs-unfold-invoker btn btn-white"
                       href="{{route('admin.orders.list',['status'=>'all'])}}">
                        <i class="tio-shopping-cart-outlined mr-1"></i> {{__('Orders')}}
                    </a>
                </div>
                <!-- End Unfold -->
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 mb-3 mb-lg-12">
                ...
                <div class="card h-100">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title">{{__('Weekly')}} {{__('Report')}} </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#{{$order['id']}} <small
                                                            class="font-size-sm text-body text-uppercase">{{__('Orders')}} {{__('ID')}}</small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0">{{__('Order')}} {{__('Amount')}}
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        {{__('Orders')}}  {{__('Status')}} <strong> : {{ Illuminate\Support\Str::ucfirst($order['order_status']) }} <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
                                       ...
                                       href="{{route('admin.orders.details',['id'=>$order['id']])}}">
                                        <div class="card-body py-0">
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#{{$order['id']}} <small
                                                            class="font-size-sm text-body text-uppercase">{{__('ID')}}</small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0">{{__('Order')}} {{__('Amount')}} 
                                                        : {{\App\CPU\BackEndHelper::usd_to_currency($order['order_amount'])}} {{\App\CPU\BackEndHelper::currency_symbol()}}</h5>
                                                    <small
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        {{__('Status')}} <strong> : {{ Illuminate\Support\Str::ucfirst($order['order_status']) }} <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
