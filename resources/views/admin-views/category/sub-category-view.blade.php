...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class=" mb-0 text-black-50">{{ __('sub_category')}}</h4>
    </div>
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <label for="name">{{ __('select_category_name')}}</label>
                        ...
                        <div class="card-footer">
                            <a id="add" class="btn btn-primary" style="color: white">{{ __('save')}}</a>
                    ...
                    <div class="table-responsive">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th scope="col" style="width: 80px">{{ __('action')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                id="{{$category['id']}}"> {{ __('Edit')}}</a>
                                                <a class="dropdown-item delete"style="cursor: pointer;"
                                                id="{{$category['id']}}">  {{ __('Delete')}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                ...
                success: function (data) {
                    if (data.length != 0) {
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            html += '<td><div class="dropdown"><button class="btn btn-outline-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="tio-settings"></i></button><div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><a class="dropdown-item  edit" style="cursor: pointer;" id="' + data[count].id + '"><?= __('Edit') ?></a><a class="dropdown-item delete"style="cursor: pointer;" id="' + data[count].id + '"> {{ __('Delete')}}</a></div></div></td></tr>';
                        }
                        $('tbody').html(html);
                    }
                }
