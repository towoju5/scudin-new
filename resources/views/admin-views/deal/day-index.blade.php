...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{__('deal_of_the_day')}}</li>
            <li class="breadcrumb-item">{{__('add_new')}}</li>
        </ol>
    </nav>

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50">{{ __('deal_of_the_day')}}</h1>
    </div>
                ...
                <div class="card-body">
                    <form action="{{route('admin.deal.day')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="name">{{ __('Products')}}</label>
                                    <select
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th scope="col" style="width: 100px">{{ __('action')}}</th>
                            </tr>
                            </thead>
                            <tbody>
