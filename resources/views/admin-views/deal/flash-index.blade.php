...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{__('flash_deal')}}</li>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50">{{ __('flash_deals')}}</h1>
    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="padding-top: 20px">
                                    <label for="name">{{__('Upload')}} {{__('Image')}}</label>
                                ...
                                <div class="col-md-12">
                                    <center>
                                        <img style="width: auto;border: 1px solid; border-radius: 10px; max-height:200px;" id="viewer"
                                            src="{{asset('assets\back-end\img\1920x400\img2.jpg')}}" alt="banner image"/>
                                    </center>
                                </div>
                            </div>
                        </div>
                            ...
                            @foreach($flash_deal as $k=>$deal)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.deal.__delete', $deal->id) }}"
