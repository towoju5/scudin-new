            ...
            <div class="row">
                <div class="col-12 " style="padding:15px;" header>
                    <div style="float: left;padding: 15px">
                        <img height="70" width="100%" src="{{ asset(website_logo()) }}"
                             alt="">
                        <p style="margin-bottom: 0px;">Support Number:{{$company_phone}}</p>
                        <p style="margin-top: 5px; margin-bottom: 0px;" >Email:{{$company_email}}</p>
                    </div>
                    <div style="float: right;padding: 0 15px 15px 15px; margin-left:20%;">
                        <h1 style="color: #030303; margin-bottom: 0px">INVOICE</h1>
                        <h3 style="color: #030303; margin-top: 4px; margin-bottom:2px;">Invoice id</h3>
                        <div style=" font-size:20px;">
                            <strong style="color:{{$web_config['primary_color']}}; margin-top:4px;">{{ $order->id }}</strong>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tr>
                    <td style="width: 41%">
                        <div style="float: left">
                            ...
                            <p style=" margin-top: 6px; margin-bottom:0px;">{{ $order->shipping['address'] ?? NULL }}</p>
                            <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->shipping ? $order->shipping['city'] : NULL}} {{$order->shipping ? $order->shipping['zip'] : NULL }}</p>
                            <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->shipping ? $order->shipping['country'] : NULL}}</p>
                        </div>
                    </td>
                    {{-- <td>
                        <div style="float: left;">
        ...
        <table class="customers">
            ...
            @foreach($order->details as $key=>$details)
                ...
                <tr class="for-tb" style=" border: 1px solid #D8D8D8;">
                    ...
                    <td class="for-tb">{{ $details->product->name ?? $p_name }}</td>
