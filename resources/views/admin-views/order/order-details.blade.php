                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-md-3 mb-3 mb-md-0 product-name">
                                                <p> {{substr($detail->product['name'],0,10)}}{{strlen($detail->product['name'])>10?'...':''}}</p>
                    ...
                    @if($order->customer)
                        <div class="card-body">
                            <div class="media align-items-center" href="javascript:">
                                <div class="avatar avatar-circle mr-1">
                                    <img class="icon icon-soft-info icon-circle"
                                        onerror="this.src='<?= asset('assets/front-end/img/image-place-holder.png') ?>'"
                                        src="{{asset($order->customer->image)}}"
                                        alt="Image">
                                </div>
                                <div class="media-body">
                                <span
                            ...
                            <div class="media align-items-center" href="javascript:">
                                <div class="icon icon-soft-info icon-circle mr-1">
                            ...
                            <ul class="list-unstyled list-unstyled-py-2">
                                <li class="mb-1">
                                    <i class="icon icon-soft-info icon-circle tio-online mr-1"></i>
                                    {{$order->customer['email']}}
                                </li>
                                <li class="mb-1">
                                    <i class="icon icon-soft-info icon-circle tio-android-phone-vs mr-1"></i>
