...
<div class="container-fluid">
    <div class="row align-items-center mb-3">
        <div class="col-sm">
            <h1 class="page-header-title">{{__('Orders')}} <span
                    class="badge badge-dark ml-2">{{\App\Model\OrderDetail::where('seller_id',auth('seller')->id())->count()}}</span>
            </h1>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50">{{__('Seller')}} : {{$seller['f_name'].' '.$seller['l_name']}} , ID : {{$seller['id']}}</h1>
    </div>
