...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class=" mb-0 text-black-50">{{ __('social_media')}}</h4>
    </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Enter Social Media Name" required>
                                    --}}
                                    <label for="name">{{__('name')}}</label>
                                ...
                                <div class="col-md-12">
                                    <input type="hidden" id="id">
                                    <label for="link">{{ __('social_media_link')}}</label>
                                    <input type="text" name="link" class="form-control" id="link" placeholder="Enter Social Media Link" required>
                                </div>
                                <div class="col-md-12">
                                    <input type="hidden" id="id">
                                    {{-- <label for="icon">{{ __('social_media_icon')}}</label>
                                    <input type="text" name="icon" class="form-control" id="icon" placeholder="Enter Social Media Icon" required> --}}
            ...
            success: function(data) {
                ...
                if (data.length != 0) {
                    ...
                    for (var count = 0; count < data.length; count++) {
                        ...
                        html += '<td><a type="button" class="edit" id="' + data[count].id + '"><i class="fa fa-edit mr-1"></i></a>';
                        html += '<a type="button" class="delete" id="' + data[count].id + '"><i class="fa fa-trash"></i></a> </td></tr>';
                    }
                    $('tbody').html(html);
                }
            }
