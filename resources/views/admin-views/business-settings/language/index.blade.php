    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{__('language_setting')}}</li>
            </ol>
        </nav>
        ...
        <div class="d-md-flex_ align-items-center justify-content-between mb-2">
            <div class="row">
                <div class="col-md-8">
                    <h3 class="h3 mb-0 text-black-50">{{__('language')}}</h3>
                </div>
                ...
                <div class="col-md-4">
                    <button class="btn btn-primary btn-icon-split float-right" data-toggle="modal"
                        ...
                        <span class="text">{{__('add_new_language')}}</span>
                    </button>
                </div>
            </div>
        </div>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    @if($data['code']!='en')
                                                        <a class="dropdown-item"
                                                           href="{{route('admin.business-settings.language.delete',[$data['code']])}}">{{__('Delete')}}</a>
                                                    @endif
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.business-settings.language.translate',[$data['code']])}}">{{__('Translate')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{__('new_language')}}</h5>
                    ...
                    <form action="{{route('admin.business-settings.language.add-new')}}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="recipient-name"
                                       class="col-form-label">{{__('language')}} </label>
                                <input type="text" class="form-control" id="recipient-name" name="name">
                            </div>
                            <div class="form-group">
                                <label for="message-text"
                                       class="col-form-label">{{__('language_code')}}</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary">{{__('Add')}} <i
