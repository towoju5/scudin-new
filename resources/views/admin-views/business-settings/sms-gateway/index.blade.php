...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{__('SMS')}} {{__('Gateway')}} </li>
        </ol>
    </nav>
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class="mb-0 text-black-50">{{__('SMS')}} {{__('Gateway')}}</h4>
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body" style="padding: 20px">
                    <h5 class="text-center">{{__('NEXMO')}} {{__('SMS')}} </h5>
                    ...
                    <form action="{{route('admin.business-settings.sms-gateway.update',['sms_nexmo'])}}"
                        ...
                        @if(isset($config))
                            <div class="form-group mb-2">
                                <label class="control-label">{{__('nexmo_gateway')}}</label>
                            </div>
