...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{__('terms_and_condition')}}</li>
        </ol>
    </nav>
                ...
                <form action="{{route('admin.business-settings.update-terms')}}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="editor">{{__('terms_and_condition')}}</label><textarea class="form-control" id="editor" name="value">{{$terms_condition->value}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
