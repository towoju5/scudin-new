...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{route('admin.product.list', 'in_house')}}">{{__('Product')}}</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="product-form" action="{{route('admin.product.update',$product->id)}}" method="post" enctype="multipart/form-data" id="product_form">
                @csrf
                <div class="card">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control ecat_id" name="category_id" id="category_id" onchange="getRequest('{{url('/')}}/admin/product/get-categories?parent_id='+this.value,'sub-category-select','select')">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control" name="sub_category_id" id="sub-category-select" data-id="{{count($product_category)>=2?$product_category[1]->id:''}}" onchange="getRequest('{{url('/')}}/admin/product/get-categories?parent_id='+this.value,'sub-sub-category-select','select')">
                                    </select>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <div class="col-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <a href="{{route('admin.product.remove-image',['id'=>$product['id'],'name'=>$photo])}}" class="btn btn-danger btn-block">Remove</a>
...
@push('js')
    ...
    <script>
        ...
        $("#sub-category-select").change(function() {
            ...
            $.ajax({
                url: "{{ route('get_p_type') }}?type=" + $p_type + "&product={{ $product->id }}",
                // dataType: 'JSON',
                type: 'get',
                success: function(data) {
                console.log(data);
