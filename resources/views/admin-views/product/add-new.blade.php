...
<section id="dashboard-ecommerce">
  ...
  <div class="row">
    <div class="col-md-12">
      <form class="product-form" action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data" id="product_form">
        @csrf
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="name" value="{{old('name')}}" placeholder="Ex : iMac Mini 2012" required>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-4">
                  ...
                  <select class="select2 js-example-basic-multiple js-states js-example-responsive form-control ecat_id" name="category_id" onchange="getRequest('{{url('/')}}/admin/product/get-categories?parent_id='+this.value,'sub-category-select','select')" required>
                ...
                <div class="col-md-4">
                  ...
                  <select class="select2 js-example-basic-multiple js-states js-example-responsive form-control" name="sub_category_id" id="sub-category-select" onchange="getRequest('{{url('/')}}/admin/product/get-categories?parent_id='+this.value,'sub-sub-category-select','select')">
                  </select>
                </div>
                <div class="col-md-4">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <input type="number" name="weight" class="form-control" id="weight" step="any" value="{{old('weight')}}" placeholder="Ex : 2" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="row pt-4">
                <div class="col-md-4">
                  ...
                  <input type="number" min="0" value="{{old('height')}}" step="0.01" placeholder="{{__('height')}}" name="height" class="form-control">
                </div>
      ...
      success: function(data) {
        ...
        if (data.errors) {
          ...
          setInterval(function() {
            location.href = "{{url('admin/product/list/in_house')}}";
          }, 2000);
        }
      },
    });
