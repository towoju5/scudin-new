...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50"> {{__('Banner')}}</h1>
    </div>
    <div class="row">
        <div class="col-md-12" id="banner-btn">
            <button id="main-banner-add" class="btn btn-primary"><i class="tio-add-circle"></i> {{ __('add_main_banner')}}</button>
            <!--<button id="secondary-banner-add"
                    class="btn btn-primary ml-2"><i class="tio-add-circle"></i> {{ __('add_secondary_banner')}}</button>
            <button id="popup-banner-add"
                    class="btn btn-primary ml-2 propup"><i class="tio-add-circle"></i>  {{ __('add_popup_banner')}}</button>  -->
        </div>
    </div>
    <!-- Content Row -->
                ...
                <div class="card-body">
                    <form action="{{route('admin.banner.store')}}" method="post" enctype="multipart/form-data" class="banner_form">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="name">{{ __('Banner Text')}}</label>
                                    <input type="text" name="url" class="form-control" id="url" required>
                                    <input type="hidden" id="type" name="banner_type" value="Main Banner">
                                    <label for="name">{{ __('Image')}}</label><br>
                                    <div class="custom-file">
                                        <input type="file" name="image" id="mbimageFileUploader" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="mbimageFileUploader">{{__('choose')}} {{__('file')}}</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <center>
                                        <img style="width: 100%;border: 1px solid; border-radius: 10px; max-height:200px;" id="mbImageviewer"
                        ...
                        <div class="card-footer">
                            <a class="btn btn-secondary text-white cancel">{{ __('Cancel')}}</a>
                            <button id="add" type="submit" class="btn btn-primary">{{ __('save')}}</button>
                            <a id="update" class="btn btn-primary"
                            style="display: none; color: #fff;">{{ __('update')}}</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="banner_form" action="{{route('admin.banner.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image" id="fbimageFileUploader" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="fbimageFileUploader">{{__('choose')}} {{__('file')}}</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <center>
                        ...
                        <div class="card-footer">
                            <a class="btn btn-secondary text-white cancel">{{ __('Cancel')}}</a>
                            <button type="submit" id="addfooter" class="btn btn-primary">{{ __('save')}}</button>
                ...
                <div class="card-body">
                    <form class="banner_form" action="{{route('admin.banner.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image" id="pbimageFileUploader" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="pbimageFileUploader">{{__('choose')}} {{__('file')}}</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <center>
                        ...
                        <div class="card-secondary">
                            <a class="btn btn-secondary text-white cancel">{{ __('Cancel')}}</a>
                            <button id="addpopup" type="submit" class="btn btn-primary">{{ __('save')}}</button>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // $('#id').val(data.id);
                        ...
                        $('#mbImageviewer').attr('src', data.photo);
                        $('#cate-table').hide(); 
