...
<div class="container-fluid"> 
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{__('Employee')}} {{__('Update')}} </li>
        </ol>
    </nav>
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50">{{__('Employee')}} {{__('Update')}} </h1>
    </div>
                ...
                <div class="card-body">
                    <form action="{{route('admin.employee.update',[$e['id']])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name">{{__('Password')}}</label><small>( input if you want to change )</small>
                                    <input type="text" name="password" class="form-control" id="password"
                                           placeholder="Password">
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{__('employee_image')}}</label>
                                    ...
                                    <center>
                                        ...
                                        src="{{ asset($e->image) }}" alt="Employee thumbnail"/>
                                    </center>  
                                    </button>
                                </div>
                            </div>
