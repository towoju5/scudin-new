    ...
    <div class="row">
                    ...
                    <ul id="navbarSettings" class="js-sticky-block js-scrollspy navbar-nav navbar-nav-lg nav-tabs card card-navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="javascript:" id="generalSection">
                                <i class="tio-user-outlined nav-icon"></i>{{__('Basic')}} {{__('information')}}
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="col-lg-9">
            <form action="{{route('admin.profile.update',[$data->id])}}" method="post" enctype="multipart/form-data" id="admin-profile-form">
                ...
                <div class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h2 class="card-title h4">{{__('Basic')}} {{__('information')}}</h2>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">{{__('Full')}} {{__('name')}} <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Display name"></i></label>

                            <div class="col-sm-9">
                                <div class="input-group input-group-sm-down-break">
                                    <input type="text" class="form-control" name="name" id="firstNameLabel" placeholder="Your first name" aria-label="Your first name" value="{{$data->name}}">
                        ...
                        <!-- Form Group -->
                        <div class="row form-group">
                            <label for="phoneLabel" class="col-sm-3 col-form-label input-label">{{__('Phone')}} <span class="input-label-secondary">(Optional)</span></label>

                            <div class="col-sm-9">
                                <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel" placeholder="+x(xxx)xxx-xx-xx" aria-label="+(xxx)xx-xxx-xxxxx" value="{{$data->phone}}" data-hs-mask-options='{
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" name="email" id="newEmailLabel" value="{{$data->email}}" placeholder="Enter new email address" aria-label="Enter new email address">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-9" id="select-img">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFileUpload">{{__('image')}} {{__('Upload')}}</label>
                                </div>
                            </div>
                        </div>
            ...
            <div id="passwordDiv" class="card mb-3 mb-lg-5">
                <div class="card-header">
                    <h4 class="card-title">{{__('Change')}} {{__('your')}} {{__('password')}}</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form id="changePasswordForm" action="{{route('admin.profile.settings-password')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary">{{__('Save')}} {{__('changes')}}</button>
                        </div>
                    </form>
                    <!-- End Form -->
                </div>
...
@include('shared-partials.image-process._script',['id'=>'profile-image-modal', 'height'=>200, 'width'=>200, 'multi_image'=>false, 'route'=>route('image-upload')])
<!-- End Content -->
<!--modal-->
