              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-1">
                    ...
                    <input type="text" id="cat_name" class="form-control" placeholder="Category Name" name="cat_name" required />
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-1">
                    ...
                    <input type="file" id="cat_image" class="form-control" placeholder="Coupon Code" name="cat_image" required />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-1">
                    ...
                    <input type="hidden" id="cat_id" name="id" value="" required />
...
<script>
  ...
  $(document).ready(function() {
    datatable = $('#dataTable').DataTable({
      ...
      responsive: true,
      ordering: false,
      ajax: "{{ route('admin.sub-category.view') }}",
      columns: [{
          data: 'name'
        },
        {
      ...
      buttons: [{
        ...
        className: 'create-new btn btn-primary m-1',
        attr: {
          'onclick': "location.href='\{{route('cat.index')}}\'",
        },
        init: function(api, node, config) {
          $(node).removeClass('btn-secondary');
        }
  ...
  function edit(id) {
    rowid = id;
    $.ajax({
      url: "{{url('admin/sub-category/fetch')}}/" + rowid,
      type: "get",
      success: function(response) {
        ...
        $('#parent_id option[value='+response.id+']').attr("selected", "selected");
