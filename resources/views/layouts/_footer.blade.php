 <!-- Footer Container -->
 <footer class="footer-container typefooter-4" style="margin-top: 20px;">
       ...
       <div class="row middle2 ">
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-style">
           <div class="app-store module">
             ...
             <ul>
               <li> <a title="App Store" href="#"> <img src="{{ asset('front/image/catalog/demo/payment/app-1.png') }}" alt="App Store"> </a> </li>
               <li> <a title="App Store" href="#"> <img src="{{ asset('front/image/catalog/demo/payment/app-2.png') }}" alt="App Store"> </a> </li>
             </ul>
           </div>
         </div>
     ...
     <div class="container">
       <div class="row">
         <div class="col-lg-6 col-md-7 col-sm-12 col-xs-12 copyright-w">
           <div class="copyright">eMarket © 2018 Demo Store. All Rights Reserved. Designed by <a href="http://towoju.com/" target="_blank">Woju Technologies</a> </div>
         </div>
         <div class="col-lg-6 col-md-5 col-sm-12 col-xs-12 payment-w"> <img src="{{ asset('front/image/catalog/demo/payment/payment-4.png') }}" alt="imgpayment"> </div>
       </div>
     </div>
   </section> <!-- /Footer Bottom Container -->
   <!--Back To Top-->
